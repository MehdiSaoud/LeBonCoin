 ...
 */
final class Version20221024102816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tag_link (id INT AUTO_INCREMENT NOT NULL, tag_link_to_tag_id INT NOT NULL, UNIQUE INDEX UNIQ_D8A32647E0FF842C (tag_link_to_tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag_link_annonce (tag_link_id INT NOT NULL, annonce_id INT NOT NULL, INDEX IDX_2B25E2129F952FDB (tag_link_id), INDEX IDX_2B25E2128805AB2F (annonce_id), PRIMARY KEY(tag_link_id, annonce_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, id_seller_id INT NOT NULL, vote INT NOT NULL, INDEX IDX_5A10856479F37AE5 (id_user_id), INDEX IDX_5A108564DDD9CFE (id_seller_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tag_link_annonce ADD CONSTRAINT FK_2B25E2129F952FDB FOREIGN KEY (tag_link_id) REFERENCES tag_link (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE tag_link_annonce ADD CONSTRAINT FK_2B25E2128805AB2F FOREIGN KEY (annonce_id) REFERENCES annonce (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tag_link_annonce DROP FOREIGN KEY FK_2B25E2129F952FDB');
        $this->addSql('ALTER TABLE tag_link_annonce DROP FOREIGN KEY FK_2B25E2128805AB2F');
        ...
        $this->addSql('DROP TABLE tag_link_annonce');
